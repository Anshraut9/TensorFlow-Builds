 # Description: Use GPT-style few-shot prompting to classify input text into categories by including examples 
 #              directly in the prompt — no model fine-tuning required.
