...
#  Description: Implement a custom Mean Absolute Percentage Error (MAPE) loss function and a custom R² score metric to evaluate a regression model using TensorFlow 2.
