...
# Description:  Manually train a simple linear regression model using tf.GradientTape for automatic differentiation.
...
y = (4 * X + 1 + np.random.randn(*X.shape) * 0.5).astype(np.float32)     # Target: linear relation + noise
